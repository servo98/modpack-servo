...
> Mecanicas relevantes: [Progression](../mechanics/progression.md), [Cooking](../mechanics/cooking.md), [Dungeons](../mechanics/dungeons.md), [Champions](../mechanics/champions.md), [Bosses](../mechanics/bosses.md), [Gacha](../mechanics/gacha.md), [Game Loop](../mechanics/game-loop.md)

## Tema

Capitulo introductorio. Aprender mecanicas vanilla + Farmer's Delight + mecanicas custom + descubrir sistema RPG.
...
| Area | Detalle |
|------|---------|
| Crops | 12 (vanilla + FD: tomate, cebolla, repollo, arroz) |
| Recetas | ~25 (FD basico) |
...
| Storage | Vanilla chests |
| Create | No disponible |
...
2. Construir refugio
3. Conocer el Cooking Pot (FD)
4. Conocer la Cutting Board (FD)
5. Conocer el Stove (FD)
6. Tutorial: Space Elevator y Cajas de Envio
...
3. Plantar repollo
4. Plantar arroz
5. Tener una granja con 4+ crops
6. Domesticar animales

### Dungeon (5)
1. Craftear primera Llave Basica
2. Entrar a primera dungeon
3. Sobrevivir una dungeon completa
4. Obtener loot de un cofre de dungeon
5. Derrotar un champion en dungeon

### Combate/RPG (5)
1. Craftear un arma T0 (Flint Dagger o similar)
2. Derrotar un champion en overworld
3. Equipar Small Rune Pouch
4. Preparar Boss Key Ch1
5. Derrotar al Guardian del Bosque
...
2. Construir cocina (workstations)
3. Construir almacen
4. Construir granja
