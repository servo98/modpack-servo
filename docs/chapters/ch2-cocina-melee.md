...
> Mecanicas relevantes: [Cooking](../mechanics/cooking.md), [RPG Classes](../mechanics/rpg-classes.md), [Create Automation](../mechanics/create-automation.md), [Storage](../mechanics/storage.md), [Jewelry](../mechanics/jewelry.md)

## Tema

Cocina expandida. Create basico. Primeros Drawers. Elegir clase melee (Rogue o Warrior).
...
2. Plantar 8 crops nuevos
3. Plantar todos los 12 crops nuevos
4. Expandir la granja
5. Granja de uvas
...
2. Craftear armor T1 de clase
3. Craftear arma T1 de clase
4. Equipar Fire o Healing rune
5. Derrotar a la Bestia Glotona

### Exploracion (5)
1. Encontrar ore de Citrine
2. Encontrar ore de Jade
3. Explorar 3 biomas nuevos
4. Colocar 3 Waystones
5. Encontrar NPC Arms Dealer (si spawna)
