...
> Mecanicas relevantes: [RPG Classes](../mechanics/rpg-classes.md), [Dungeons](../mechanics/dungeons.md), [Space Elevator](../mechanics/space-elevator.md), [Bosses](../mechanics/bosses.md), [Game Loop](../mechanics/game-loop.md)

## Tema

Todo desbloqueado. Tier 4 legendario. Mega-entregas. Boss final epico con 4 fases.

## Mods nuevos

Ninguno. Todo ya esta disponible.
...
- Aeternium: Dagger, Double Axe, Glaive, Sickle, Claymore, Great Hammer, Kite Shield, Mace
- Ruby: mismas + Holy Staff
- Especiales: Ruby Fire Staff, Smaragdant Frost Staff, Valkyrie Magister Staff

Materiales: Cristal del Nucleo + Rubi Infernal (drops de bosses)
...
2. Completar toda la historia
3. Craftear Item Maestro
4. Craftear primera arma T4
5. Completar set T4
6. Preparacion de arena para boss final
7. Mega-entrega al Space Elevator
8. Derrotar al Devorador de Mundos
...
2. Plantar TODOS los crops (70+)
3. Full auto para todos los crops
4. Producir 100+ comidas empacadas
5. Granja perfecta (todos los crops en una granja)
6. Automatizar TODO el pipeline

### Dungeon (5)
1. Completar 10 runs Del Nucleo
2. Farmear Fragmentos de Cristal (15+ para T4)
3. Coleccionar 20+ unique jewelry
4. Obtener accesorio T5 (legendario)
5. Completar dungeon sin morir (challenge)

### Combate/RPG (5)
1. Craftear arma T4 legendaria
2. Craftear set T4 completo
3. Maxear Skill Tree
4. Equipar mejor build posible (T4 + uniques + T5 accesorios)
5. Derrotar al Devorador de Mundos

### Exploracion (5)
1. Visitar todos los biomas
2. Completar mapa 100%
3. Red de transporte global
4. Todas las Waystones
5. Explorar todo el Nether

### Construccion (4)
1. Base legendaria completa
2. Museo de trofeos (todos los bosses)
